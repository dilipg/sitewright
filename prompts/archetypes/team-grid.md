...
export const teamGridData: TeamGridProps = {
  ...
  members: [
    { key: "priya-nair", name: "Priya Nair", role: "Co-founder & CEO", photoSrc: PLACEHOLDER_IMAGE, photoAlt: "Portrait of Priya Nair" },
    { key: "marcus-webb", name: "Marcus Webb", role: "Co-founder & Head of Product", photoSrc: PLACEHOLDER_IMAGE, photoAlt: "Portrait of Marcus Webb" },
    { key: "elena-cruz", name: "Elena Cruz", role: "Lead Engineer", photoSrc: PLACEHOLDER_IMAGE, photoAlt: "Portrait of Elena Cruz" },
  ],
};
```
