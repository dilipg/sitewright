...
export const categoryNavData: CategoryNavProps = {
  ...
  categories: [
    { key: "candles", name: "Candles", imageSrc: "https://images.yourbrand.example/categories/candles.jpg", imageAlt: "A row of lit candles", href: "/shop" },
    { key: "diffusers", name: "Diffusers", imageSrc: "https://images.yourbrand.example/categories/diffusers.jpg", imageAlt: "A reed diffuser on a shelf", href: "/shop" },
    { key: "gift-sets", name: "Gift Sets", imageSrc: "https://images.yourbrand.example/categories/gift-sets.jpg", imageAlt: "A wrapped gift set box", href: "/shop" },
  ],
};
```
